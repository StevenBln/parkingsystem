...
public class FareCalculatorServiceTest {
    ...
    @Test
    public void verifyFreeParkingFee() {
        Date inTime = new Date();
        inTime.setTime(System.currentTimeMillis() - (30 * 60 * 1000));// Parking fee for 30min should be 0
        Date outTime = new Date();
        ParkingSpot parkingSpot = new ParkingSpot(1, ParkingType.CAR, false);
    ...
    public void discount() {
        ...
        assertEquals(ticket.getPrice(), FareCalculatorService.DISCOUNT_FACTOR * Fare.CAR_RATE_PER_HOUR);
    }
}